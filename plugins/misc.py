...
async def song(bot, update):
    await update.reply_photo(
            ...
            caption='ᴅᴏɴᴛ ᴋɴᴏᴡ ʜᴏᴡ ᴛᴏ sɪɴɢ ɪᴛ ʙʀᴏ...😂'
    )
...
async def about(bot, update):
    await update.reply_photo(
            ...
            caption='I ᴀᴍ ᴇsᴘᴇᴄɪᴀʟʟʏ ᴀʙᴏᴜᴛ ɪᴛ, I ᴅᴏɴᴛ ʜᴀᴠᴇ ᴀɴʏ ᴀʙɪʟɪᴛʏ.. Mʏ ʙᴏss ɪs ᴍʏ ᴇᴠᴇʀʏᴛʜɪɴɢ (Zᴀғᴀʀ sɪʀ) Jᴜsᴛ ᴛʜᴇ ᴏᴡɴᴇʀ ᴡɪʟʟ sᴀʏ I ᴡɪʟʟ ʙᴇʟɪᴇᴠᴇ ɪᴛ.. Iғ I ᴏʙᴇʏ ᴛʜᴇɴ I ᴡɪʟʟ ɢᴇᴛ ᴀ ʀᴏᴛɪ.. 😌'
    )
...
async def source(bot, update):
    await update.reply_photo(
            ...
            caption='ᴍʏ ᴄᴏᴅᴇ ɪs ᴘʀɪᴠᴀᴛᴇ...ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀsᴋ ᴍʏ ʙᴏss..😌..'
    )
...
async def help(bot, update):
    await update.reply_photo(
            ...
            caption='Cᴏᴍᴇ ᴀɴᴅ ʜᴇʟᴘ ᴍᴇ ᴡʜᴇɴ Iᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ....😂'
    )
